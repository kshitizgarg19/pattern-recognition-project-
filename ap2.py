...
# Feature Importance (For Random Forest) or Top Features
if model_choice == "Random Forest":
    feature_importances = model.feature_importances_
    top_features = np.argsort(feature_importances)[::-1][:10]
else:
    top_features = list(range(10))  # Select the first 10 features as placeholders for other models
...
if st.button("Predict"):
    ...
    # Visualize Predicted vs Actual for Supervised Models
    if model_choice != "KMeans":
